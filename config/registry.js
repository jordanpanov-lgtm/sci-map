...
const FIELDS = [
  ...
  { id:"microbiology-virology",      domain:"life-sciences",     label:"Microbiology & Virology",                   sub:"Bacteria, viruses & the microbial world",                               status:"ready", file:"modules/microbiology-virology.json" },
  { id:"botany",                     domain:"life-sciences",     label:"Botany & Plant Sciences",                   sub:"Plant structure, physiology, diversity & ecology",                      status:"ready", file:"modules/botany.json" },
  ...
  { id:"evolutionary-biology",       domain:"life-sciences",     label:"Evolutionary Biology",                      sub:"Population genetics, speciation, phylogenetics & the mechanisms of evolutionary change", status:"ready", file:"modules/evolutionary-biology.json" },
  ...
  { id:"applied-math-statistics",    domain:"formal-computing",  label:"Applied Math & Statistics",                 sub:"Probability, statistics, optimisation, operations research & cryptography", status:"ready", file:"modules/applied-math-statistics.json" },
